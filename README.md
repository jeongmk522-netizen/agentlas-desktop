...
- **2026-09-09 · v1.1.10 — 공통 브라우저와 작업 결과** — One과 Work에서 실행 URL은 브라우저로 열고, 캡처와 파일은 결과 보기에서 확인합니다. 작업자 인계 후에도 미리보기 서버를 유지하며 요청한 작업 범위에 맞춰 완료를 검증합니다. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`. Source readiness does not prove a public installer or update feed; the Releases page stays the authority.
- **2026-09-08 · v1.1.9 — 길어진 대화에서도 가볍고, 목표가 실제로 닫힙니다** — 실행 활동 기록이 수천 줄 쌓여도 화면이 무거워지지 않습니다(끝난 작업은 접히고, 펼쳐도 창 단위로 보여 줍니다 — 기록은 지우지 않습니다). 목표를 켜면 계약이 함께 만들어져 진행과 완료가 됩니다. 모든 말풍선이 필요한 폭보다 12% 좁던 것, "건너뛰기"가 적어 둔 답을 보내던 것, 결과 목록이 없는 파일을 잘못 말하던 것을 고쳤습니다. Science는 연구 재개·자료 인용·CSV 가져오기가 막히던 자리를 열었고, 사전 등록 계획의 잠금은 그대로 둡니다. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`. Source readiness does not prove a public installer or update feed; the Releases page stays the authority.
- **2026-09-07 · v1.1.8 — Science가 스스로 연구합니다** — 처음 쓰는 사람도 모델을 고르지 않고 바로 연구를 시작할 수 있고, 자율 진행 권한을 이미 가진 연구가 승인 앞에서 멈추지 않으며, 긴 연구 요청이 시작 전에 죽지 않습니다. 모든 목적지 화면의 좌우 여백·읽는 폭·제목 크기를 하나로 맞췄고, 왼쪽 메뉴에서 결과·원고·제출이 먼저 잘리지 않습니다. 데이터 표는 정렬·필터가 되는 가상 스크롤 표(Tabulator, MIT)로 바뀌었습니다. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`. Source readiness does not prove a public installer or update feed; the Releases page stays the authority.
- **2026-09-07 · v1.1.7 — Science runtime and research recovery** — Ships the required Science image and molecular runtime dependencies, checks the packaged native image runtime on Windows and POSIX paths, binds manuscript exports to their selected journal rules, and keeps research continuation and project refresh state consistent. Missing legacy test imports no longer clutter selectable workers. Graph can refresh, resume, or start a reviewed new run while retaining history. One Hub attachments use a confirmed lease and preserve purchase identity across retries. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`. Source readiness does not prove a public installer or update feed; the Releases page stays the authority.

- **2026-09-06 · v1.1.4 — Startup recovery and Science installation** — Fixes database upgrades from 1.1.1 and enables Science installation in Settings and the product menu. If 1.1.3 cannot open, quit Agentlas and replace the app with the 1.1.4 installer while keeping the application data folder. This release binds Agentlas OS v1.2.44 at 1f6d64374502cfd5f8581ad3c1fb18691ed61b1d. Its public runtime asset `hephaestus-runtime-v1.2.44.tar.gz` is pinned at SHA-256 `795d1c294db662475d4eb0c7e4562ba0ca1e0f27d3b1da0f5e9c6e7cf627d83a`. Source readiness does not prove a public installer or update feed; the Releases page stays the authority.
